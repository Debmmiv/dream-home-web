...
export default function AddPropertyForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
        const activeToken = await getValidAccessToken();
        await apiClient.post('properties/create/', { 
            data: formData,
            token: activeToken 
        });
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <h3 className="text-lg font-semibold text-slate-800 mb-4 flex items-center gap-2">
                <span className="bg-blue-50 text-[#003580] w-8 h-8 rounded-full flex items-center justify-center text-sm">1</span>
                Rent & Type
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                    ...
                    branches.map((b) => (
                        ...
                        {/* 🌟 UPDATED: Shows "Street, Area" (Address and Barangay) */}
            ...
            <h3 className="text-lg font-semibold text-slate-800 mb-4 flex items-center gap-2">
                <span className="bg-blue-50 text-[#003580] w-8 h-8 rounded-full flex items-center justify-center text-sm">2</span>
                Location
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="pt-6 border-t border-slate-100">
            <h3 className="text-lg font-semibold text-slate-800 mb-4 flex items-center gap-2">
                <span className="bg-blue-50 text-[#003580] w-8 h-8 rounded-full flex items-center justify-center text-sm">3</span>
                Description
            </h3>
            <textarea 
                name="description" 
            ...
            <button type="submit" className="bg-[#003580] hover:bg-[#002a6e] text-white px-8 py-3.5 rounded-xl font-bold shadow-md transition-all">
